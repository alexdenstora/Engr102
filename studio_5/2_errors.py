...
def you_forgot_something():
    ...
    # Your Answer: The single equals sets a variable equal to a value or string while a double equals checks to see if a variable is equal to another value or string.
