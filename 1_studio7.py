...
def main():
    ...
    rows = load_csv_file("SalarySurvey.csv")
    ...
    #average salary break down by age
    ...
    #average salary break down by highest education
    ...
    #average salary break down by experience
    years_experience = group_by_attribute(participants, "experience")
    average_salaries_by_years_of_experience = get_average_salary(years_experience)

    print("Answer to Question #5:")
    for group in average_salaries_by_years_of_experience:
        print(group.key, group.average)
